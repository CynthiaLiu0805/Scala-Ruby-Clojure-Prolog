...
class STTerm 
  ...
  class STTest < STTerm
    ...
    def typeOf(arr); t2.typeOf(Array.new) end
...
c=STZero.new
# puts()
STIsZero.new(STZero.new)
# puts (STTest.new(STTrue.new,STZero.new,STZero.new).typeOf(Array.new))
# puts (STApp.new(STAbs.new(STNat.new,STVar.new(0)),STZero.new).typeOf(Array.new))
# puts (STAbs.new(STNat.new,STFalse.new).typeOf(Array.new))
# STAbs(STNat, STAbs(STBool, STVar(1)))

puts (STAbs.new(STNat.new,STAbs.new(STBool.new,STVar.new(1))).typecheck)
puts (STAbs.new(STFun.new(STNat.new,STNat.new),
STAbs.new(STNat.new,STApp.new(STVar.new(1),STVar.new(0)))).typecheck)
puts (STApp.new(STAbs.new(STNat.new,STVar.new(0)),STZero.new).eraseTypes)
puts (ULApp.new(ULAbs.new( ULVar.new(0)),ULAbs.new(ULAbs.new(ULVar.new(0)))))